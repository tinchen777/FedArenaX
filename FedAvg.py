...
from src.fedarenax import SimpleNN, train_loader, test_loader, federated_averaging
...
if __name__ == "__main__":
    ...
    for r in range(ROUNDS):
        ...
        for client in range(CLIENT_NUM):
            train(copy.deepcopy(model), train_loader, optimizer, criterion, num_epochs=1)
